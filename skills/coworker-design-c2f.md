---
name: coworker-design-c2f
triggers:
  - c2f
  - mark feature complete
  - update FEATURE.md from code
  - sync features
description: |
  Scan code to mark implemented features as COMPLETE in FEATURE.md. Run after
  implementing a feature to keep the feature tracker accurate.
services:
  category: coworker-design
when_to_use: |
  After implementing a feature listed in FEATURE.md. When user says "c2f",
  "mark this as done in FEATURE.md", or "update feature status".
when_not_to_use: |
  Skip if FEATURE.md does not exist in the project.
version: 1.0.0
---

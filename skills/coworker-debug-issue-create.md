---
name: coworker-debug-issue-create
triggers:
  - create github issue
  - file a bug
  - new feature request
  - track this change
description: |
  Doc-driven change request via GitHub Issue — 6-step structured discussion
  before any code. All non-trivial changes start here, not in the editor.
services:
  category: coworker-debug
when_to_use: |
  When user reports a bug, requests a feature, or wants to track any change.
  Always create an issue before writing code for non-trivial work.
when_not_to_use: |
  Skip for changes under 30 minutes with no discussion needed. Use coworker-do-quick-task.
version: 1.0.0
---

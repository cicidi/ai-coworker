...
triggers:
  ...
  - github mcp
description: |
  GitHub MCP — create, search, comment on issues and PRs via official MCP server.
  Use for all GitHub interactions.
services:
  category: coworker-tool
when_to_use: |
  When user wants to interact with GitHub: create issues, open PRs, search
  repos, add comments, or manage branches.
when_not_to_use: |
  false
version: 1.0.0
---

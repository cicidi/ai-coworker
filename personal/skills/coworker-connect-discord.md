...
description: |
  Discord MCP — send messages, read channels, manage notifications via Discord bot.
  Use when user wants to interact with Discord.
services:
  category: coworker-tool
when_to_use: |
  When user wants to send a Discord message, read a channel, or get notified
  via Discord. Requires Discord MCP server to be configured.
when_not_to_use: |
  false
version: 1.0.0
---
